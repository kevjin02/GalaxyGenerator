...
const generateGalaxy = () => {
  ...
  for (let i = 0; i < parameters.count; i++) {
    ...
    const radius =
      Math.pow(Math.random(), parameters.radiusStrength) * parameters.radius;
...
gui.add(parameters, "radius", 0, 10).onFinishChange(generateGalaxy);
...
gui.add(parameters, "radiusStrength", 0, 10).onFinishChange(generateGalaxy);
